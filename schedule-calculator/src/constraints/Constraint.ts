...
export default abstract class Constraint {
    ...
    abstract isValid(currentSchedule: SchedulePossibilities | undefined, section: SectionPossibilities | Section): boolean | boolean[];

    get constraintApplied(): ConstraintApplied { return this._constraintApplied; }
    set constraintApplied(constraintApplied: ConstraintApplied) { this._constraintApplied = constraintApplied; }
}