...
import { Component, isOneTimeComponent, stringToComponent } from "../course-structure/Component"
import { Campus, stringToCampus } from "../course-structure/Campus"
import { LocationTaught, stringToLocationTaught } from "../course-structure/LocationTaught"
...
function classNumberParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
    sectionDict.classNumber = +node.textContent
}

function componentParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
...
function campusAndLocationParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
...
function associateClassNumberParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
    sectionDict.associateClassNumber = +node.textContent
}

function enrolCapParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
    sectionDict.enrolCap = +node.textContent
}

function enrolTotalParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
    sectionDict.enrolTotal = +node.textContent
}

function timeAndDateParser(sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) {
...
const IDX_ITEM_FUNC: (((sectionDict: { [key: string]: unknown }, node: HTMLTableCellElement) => void) | undefined)[] = [
    classNumberParser, componentParser, campusAndLocationParser, associateClassNumberParser, undefined, undefined,
    enrolCapParser, enrolTotalParser, undefined, undefined, timeAndDateParser, undefined
]
...
function dictToSection(dict: { [key: string]: unknown }) {
    ...
    if (isOneTimeComponent(dict.component as Component)) {
        return new OneTimeSection(dict.courseName as string, dict.classNumber as number, dict.component as Component, dict.componentNumber as number, dict.date as Date, dict.timeslot as Timeslot, dict.enrolCap as number, dict.enrolTotal as number, '', dict.campus as Campus, dict.locationTaught as LocationTaught)
    } else {
        return new WeeklySection(dict.courseName as string, dict.classNumber as number, dict.component as Component, dict.componentNumber as number, dict.days as Days[], dict.timeslot as Timeslot, dict.enrolCap as number, dict.enrolTotal as number, '', dict.campus as Campus, dict.locationTaught as LocationTaught)
    }
}
...
async function getCourseDetails(subject: string, catalogNumber: number, term: number, html?: string) {
    if (!html) {
