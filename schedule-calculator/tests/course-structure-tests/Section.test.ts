...
describe('All Sections', () => {
    ...
    const weeklySection = new WeeklySection("CS 136", 1, ComponentSection.LEC, days, timeslot, 30, 0, 'Deniz');
    ...
    describe('doesOverlap', () => {
        it('should return true if two WeeklySections overlap', () => {
            ...
            const overlappingSection = new WeeklySection("CS 136", 2, ComponentSection.LEC, overlappingDays, overlappingTimeslot, 30, 0, 'Instructor');
        ...
        it('should return false if two WeeklySections do not overlap', () => {
            ...
            const nonOverlappingSection = new WeeklySection("CS 136", 3, ComponentSection.LEC, nonOverlappingDays, nonOverlappingTimeslot, 30, 0, 'Instructor');
    ...
    describe('doDaysOverlap', () => {
        it('should return true if two WeeklySections have overlapping days', () => {
            ...
            const overlappingSection = new WeeklySection("CS 136", 2, ComponentSection.TUT, overlappingDays, timeslot, 30, 0, 'Instructor');
        ...
        it('should return false if two WeeklySections do not have overlapping days', () => {
            const nonOverlappingDays = [Days.tuesday, Days.thursday];
            const nonOverlappingSection = new WeeklySection("CS 136", 3, ComponentSection.TUT, nonOverlappingDays, timeslot, 30, 0, 'Instructor');
    ...
    describe('isOpen', () => {
        it('should return true if enrolTotal is less than enrolCap', () => {
            const section = new WeeklySection("CS 136", 3, ComponentSection.TUT, [Days.tuesday, Days.thursday], timeslot, 30, 29, 'Instructor');
            expect(section.isOpen()).toBe(true);
        });

        it('should return false if enrolTotal is equal to enrolCap', () => {
            const section = new WeeklySection("CS 136", 3, ComponentSection.TUT, [Days.tuesday, Days.thursday], timeslot, 30, 30, 'Instructor');
    ...
    describe('constructor: OneTimeSection', () => {
        it('should create a OneTimeSection instance with correct properties', () => {
            const oneTimeSection = new OneTimeSection("CS 136", 1, ComponentSection.TST, date, timeslot, 30, 0, 'Instructor');
    ...
    describe('doesOverlap: OneTimeSection', () => {
        it('should return false if comparing with a WeeklySection', () => {
          const weeklySection = new WeeklySection("CS 136", 2, ComponentSection.LEC, [Days.monday], timeslot, 30, 0, 'Instructor');
          const oneTimeSection = new OneTimeSection("CS 136", 1, ComponentSection.LEC, new Date(), timeslot, 30, 0, 'Instructor');
        ...
        it('should return true if comparing with another OneTimeSection with the same date and overlapping timeslot', () => {
          ...
          const overlappingOneTimeSection = new OneTimeSection("CS 136", 2, ComponentSection.LEC, date, overlappingTimeslot, 30, 0, 'Instructor');
          const oneTimeSection = new OneTimeSection("CS 136", 1, ComponentSection.LEC, date, timeslot, 30, 0, 'Instructor');
        ...
        it('should return false if comparing with another OneTimeSection with a different date', () => {
          ...
          const differentDateOneTimeSection = new OneTimeSection("CS 136", 2, ComponentSection.LEC, differentDate, timeslot, 30, 0, 'Instructor');
          const oneTimeSection = new OneTimeSection("CS 136", 1, ComponentSection.LEC, date, timeslot, 30, 0, 'Instructor');
        ...
        it('should return false if comparing with another OneTimeSection with a non-overlapping timeslot', () => {
          const nonOverlappingTimeslot: Timeslot = new Timeslot(new Time(14, 0), new Time(16, 0));
          const nonOverlappingOneTimeSection = new OneTimeSection("CS 136", 2, ComponentSection.LEC, date, nonOverlappingTimeslot, 30, 0, 'Instructor');
          const oneTimeSection = new OneTimeSection("CS 136", 1, ComponentSection.LEC, date, timeslot, 30, 0, 'Instructor');
