...
describe('SectionPossibilities class tests', () => {
    ...
    it('canAddSection should return true if section can be added', () => {
        ...
        const newSection = new WeeklySection("CS 136", 4, Component.LEC, 1, [], timeslot, 30, 25, 'Prof. Johnson');
    ...
    it('canAddSection should return false if section cannot be added', () => {
        ...
        let newSection = new WeeklySection("CS 136", 3, Component.TUT, 1, [], timeslot, 40, 30, 'Dr. Brown');
        let canAdd = sectionPossibilities.canAddSection(newSection);

        expect(canAdd).toBe(false);

        newSection = new WeeklySection("CS 136", 3, Component.LEC, 1, [], new Timeslot(new Time(10, 0), new Time(12, 10)), 40, 30, 'Dr. Brown');
