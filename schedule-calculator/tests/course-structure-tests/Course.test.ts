...
describe('Course class tests', () => {
    ...
    beforeEach(() => {
        ...
        const sections = [
            new WeeklySection("CS 136", 1, Component.LEC, 1, days, timeslot, 50, 20, 'Dr. Smith'),
            new WeeklySection("CS 136", 2, Component.LEC, 1, days, timeslot, 30, 25, 'Prof. Johnson'),
            new WeeklySection("CS 136", 3, Component.TUT, 1, days, timeslot, 40, 30, 'Dr. Brown'),
        ];
    ...
    it('setSections should update the sections and components', () => {
        const newSections = [
            new WeeklySection("CS 136", 4, Component.LEC, 1, days, timeslot, 30, 25, 'Prof. Johnson'),
            new WeeklySection("CS 136", 5, Component.TUT, 1, days, timeslot, 40, 30, 'Dr. Brown'),
        ];
    ...
    it('doesOverlap should return true for overlapping sections', () => {
        const section1 = new WeeklySection("CS 136", 1, Component.LEC, 1, days, timeslot, 50, 20, 'Dr. Smith');
        const section2 = new WeeklySection("CS 136", 2, Component.LEC, 1, days, timeslot, 30, 25, 'Prof. Johnson');
        expect(section1.doesOverlap(section2)).toBe(true);
    });

    it('doesOverlap should return false for non-overlapping sections', () => {
        const section1 = new WeeklySection("CS 136", 1, Component.LEC, 1, days, timeslot, 50, 20, 'Dr. Smith');
        const section2 = new WeeklySection("CS 136", 2, Component.LEC, 1, days, new Timeslot(new Time(12, 0), new Time(14, 0)), 30, 25, 'Prof. Johnson');
