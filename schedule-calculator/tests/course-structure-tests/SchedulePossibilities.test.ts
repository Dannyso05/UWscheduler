...
describe('SchedulePossibilities class tests', () => {
    ...
    it('canAddSectionPossibilities should return false if sectionPossibilities has no sections', () => {
        ...
        const canAdd = schedulePossibilities.canAddSectionPossibilities(
            emptySectionPossibilities
        )
    ...
    it('canAddSectionPossibilities should return true if no overlaps exist with existing possibilities', () => {
        ...
        const section3 = new SectionPossibilities([
            new WeeklySection(
                ...
                1,
                [Days.monday, Days.tuesday],
                new Timeslot(new Time(14, 0), new Time(16, 0)),
                40,
                30,
                'Dr. Brown'
            ),
        ...
        const newSectionPossibilities = new SectionPossibilities([
            new WeeklySection(
                'CS 136',
                3,
                Component.TUT,
    ...
    it('canAddSectionPossibilities should return true if no overlaps exist with existing possibilities, with days', () => {
        ...
        const section3 = new SectionPossibilities([
            new WeeklySection(
                ...
                1,
                [Days.monday, Days.tuesday],
                new Timeslot(new Time(12, 0), new Time(16, 0)),
                40,
                30,
                'Dr. Brown'
            ),
        ...
        const newSectionPossibilities = new SectionPossibilities([
            new WeeklySection(
                ...
                new Timeslot(new Time(12, 0), new Time(18, 0)),
                40,
                30,
                'Dr. Brown'
            ),
    ...
    it('canAddSectionPossibilities should return true if no overlaps exist with existing possibilities, with days 2', () => {
        ...
        const newSectionPossibilities = new SectionPossibilities([
            new WeeklySection(
                ...
                1,
                [Days.friday],
                new Timeslot(new Time(8, 0), new Time(21, 0)),
                40,
                30,
                'Dr. Brown'
            ),
    ...
    it('canAddSectionPossibilities should return false if overlaps exist with existing possibilities', () => {
        ...
        const newSectionPossibilities = new SectionPossibilities([
            new WeeklySection(
                ...
                1,
                [Days.monday],
                new Timeslot(new Time(12, 0), new Time(14, 30)),
                40,
                30,
                'Dr. Brown'
            ),
    ...
    it('getSectionPossibilities should return the sectionPossibilities at the specified index', () => {
        ...
        const retrievedSectionPossibilities =
            schedulePossibilities.getSectionPossibilities(1)
    ...
    it('test removeSectionPossibilities and removeLastSectionPossibilities', () => {
        ...
        const section4 = new SectionPossibilities([
            new WeeklySection(
                'CS 136',
                3,
                Component.TUT,
        ...
        schedulePossibilities.addMultipleSectionPossibilities([
            section1,
            section2,
            section3,
            section4,
