...
function saveAllCoursesToJSON() {
    for (let i = 0; i < getCourseFunctions.length; i++) {
        fs.writeFileSync(
            prefix + courseNames[i] + suffix,
            JSON.stringify(getCourseFunctions[i]())
        )
    }
}

const cs136WStr = `6021	LEC 001	UW U	1	 	201	100	100	0	0	10:00-11:20
...
export function getCS136(): Course {
    return new Course(
        ...
        136,
        0.5,
        'Elem Algo Dsgn & Data Abstrac',
        StringToSections.stringToWeeklySections('CS 136', cs136WStr, [
            Days.tuesday,
            Days.thursday,
        ]).concat(
            StringToSections.stringToOneTimeSections(
                'CS 136',
                cs136OTStr,
                new Date('03/04/2024')
            )
...
const cs136LWStr1 = `6609	LAB 001	UW U	1	 	 	65	62	0	0	08:30-10:20
...
const cs136LWStr2 = `6619	LAB 011	UW U	11	 	 	65	64	0	0	08:30-10:20
...
export function getCS136L(): Course {
    return new Course(
        ...
        136,
        0.5,
        'Tools & Tech for Software Dev',
        StringToSections.stringToWeeklySections('CS 136L', cs136LWStr1, [
            Days.tuesday,
        ]).concat(
            StringToSections.stringToWeeklySections('CS 136L', cs136LWStr2, [
                Days.thursday,
            ])
        ),
        'L'
...
const math136WStr1 = `5937	LEC 001	UW U	1	 	201	120	38	0	0	08:30-09:20
...
const math136WStr2 = `6385	TUT 101	UW U	9999	 	 	263	146	0	0	04:30-05:20
...
const math136OTStr = `6091	TST 201	UW U	9999	 	 	1400	1105	0	0	07:00-08:50`
...
export function getMATH136(): Course {
    return new Course(
        ...
        136,
        0.5,
        'Linear Algebra 1 (Honours)',
        StringToSections.stringToWeeklySections('MATH 136', math136WStr1, [
            Days.monday,
            Days.wednesday,
            Days.friday,
        ]).concat(
            StringToSections.stringToWeeklySections('MATH 136', math136WStr2, [
                Days.monday,
            ]).concat(
                StringToSections.stringToOneTimeSections(
                    'MATH 136',
...
const math138WStr1 = `5945	LEC 001	UW U	1	 	201	120	120	0	0	11:30-12:20
...
const math138WStr2 = `6684	TUT 105	UW U	10	 	 	100	29	0	0	05:30-06:20
...
const math138OTStr = `6092	TST 201	UW U	9999	 	 	1200	1058	0	0	07:00-08:50`
...
export function getMATH138(): Course {
    return new Course(
        ...
        0.5,
        'Calculus 2 (Honours)',
        StringToSections.stringToWeeklySections('MATH 138', math138WStr1, [
            Days.monday,
            Days.wednesday,
            Days.friday,
        ])
            .concat(
                StringToSections.stringToWeeklySections(
                    'MATH 138',
                    math138WStr2,
                    [Days.wednesday]
                )
...
const phys124Wstr1 = `7206	LEC 001	UW U	1	 	201	250	220	0	0	11:30-12:50`

const phys124Wstr2 = `7207	TUT 101	UW U	9999	 	 	125	103	0	0	05:30-06:50`

const phys124Wstr3 = `7254	TUT 102	UW U	9999	 	 	125	117	0	0	04:00-05:20`

const phys124OTstr = `7370	TST 201	UW U	9999	 	 	250	220	0	0	06:30-07:50`
...
export function getPHYS124(): Course {
    return new Course(
        ...
        0.5,
        'Modern Physics',
        StringToSections.stringToWeeklySections('PHYS 124', phys124Wstr1, [
            Days.tuesday,
            Days.thursday,
        ])
            .concat(
...
const phys122Wstr1 = `7201	LEC 001	UW U	1	 	201	240	176	0	0	11:30-12:50`

const phys122Wstr2 = `7202	LEC 002	UW U	2	 	201	280	130	0	0	08:30-09:50`

const phys122Wstr3 = `7203	TUT 101	UW U	9999	 	 	265	135	0	0	12:30-02:20F`

const phys122Wstr4 = `7205	TUT 103	UW U	9999	 	 	127	84	0	0	04:30-06:20`

const phys122OTstr = `8206	TST 201	UW U	9999	 	 	520	306	0	0	06:30-08:20`
...
export function getPHYS122(): Course {
    return new Course(
        ...
        0.5,
        'Modern Physics',
        StringToSections.stringToWeeklySections('PHYS 122', phys122Wstr1, [
            Days.monday,
            Days.wednesday,
        ])
            .concat(
...
const tc1WStr = `1	LEC 001	UW U	1	 	201	100	100	0	0	10:00-11:20
...
export function getTestCourse1(): Course {
    return new Course(
        ...
        0.5,
        'Test course 1',
        StringToSections.stringToWeeklySections('TC 1', tc1WStr, [
            Days.tuesday,
            Days.thursday,
        ])
    )
...
const tc2WStr = `8	LEC 001	UW U	1	 	201	100	100	0	0	10:00-11:20
...
const tc2WStr2 = `14	TUT 006	UW U	6	 	201	95	95	0	0	12:00-01:20
...
export function getTestCourse2(): Course {
    return new Course(
        ...
        0.5,
        'Test course 2',
        StringToSections.stringToWeeklySections('TC 2', tc2WStr, [
            Days.tuesday,
            Days.thursday,
        ]).concat(
            StringToSections.stringToWeeklySections('TC 2', tc2WStr2, [
                Days.tuesday,
                Days.thursday,
            ])
        )
...
const tc3WStr = `15	LEC 006	UW U	6	 	201	95	95	0	0	09:30-10:20`
...
export function getTestCourse3(): Course {
    return new Course(
        ...
        0.5,
        'Test course 3',
        StringToSections.stringToWeeklySections('TC 3', tc3WStr, [
            Days.tuesday,
            Days.thursday,
        ])
    )
